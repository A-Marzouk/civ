...
Congratulations, your account @component('mail::link', ['url' => "https://civ.ie/$user->username"]) civ.ie/{{$user->username}} @endcomponent has been successfully restored on {{Carbon\Carbon::now()}}.
