                ...
                <v-card-subtitle>
                  <v-form ref="form" :lazy-validation="lazy" class="login-form">
                    <div class="input-div">
                      ...
                      ></v-text-field>
                      <div class="error--text error-custom-margin" v-if="errors.name">{{errors.name[0]}}</div>
                    </div>
                    ...
                    <div class="input-div mt-md-0 mt-sm-0 mt-n3">
                      ...
                      <v-text-field
                              ...
                              :height="windowWidth<=599 ? '33.44' : '60'"
                      ></v-text-field>
                      <div class="error--text error-custom-margin" v-if="errors.email">{{errors.email[0]}}</div>
                    </div>
                    ...
                    <div class="input-div mt-md-0 mt-sm-0 mt-n3">
                      ...
                      <v-text-field
                              ...
                              :height="windowWidth<=599 ? '33.44' : '60'"
                      ></v-text-field>
                      <div class="error--text error-custom-margin" v-if="errors.password">{{errors.password[0]}}</div>
                    </div>
  ...
  export default {
    ...
    methods: {
      register() {
        this.errors = {};
        if(!this.agreeCheck){
          this.errors.agreeCheck = 'You have to accept our Terms of Use & Privacy Police*';
          return;
        }
