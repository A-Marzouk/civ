    ...
    <div class="chat__content">
      <template v-if="!isMessageSent">
        ...
        <div class="button-section">
          ...
          <div class="right">
            <a href="javascript:void(0)" class="close-button" @click.prevent="closeChat()"> Cancel </a>
          </div>
        </div>
      </template>
      <template v-else>
        ...
        <div class="message-cancel-btn">
          <a href="javascript:void(0)" class="close-button" @click.prevent="closeChat()"> Close </a>
        </div>
      </template>
    </div>
  </div>
