      ...
      <div class="content-body">
        <div class="sub-item">
          <div class="sub-item-header">
            <div
              class="sub-item__title sub-item__title--has-point"
              v-text="item.degree_title"
            ></div>
            <div
              class="sub-item__type"
              v-if="item.institution_type"
              v-text="item.institution_type"
            ></div>
          </div>
          <div class="sub-item-detail" v-text="item.description"></div>
        </div>
      </div>
    </div>
  </div>
