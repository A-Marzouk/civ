<template>
	<div class="about-me">
		<div class="about-me__header">
			<h2 class="about-me__title">Welcome to My profile!</h2>
		</div>
		...
		<div class="about-me__detail">
			...
			<div class="detail__paragraph">
				I work to create innovative solutions that inspire, and foster memorable relationships between brands and their clients.
			</div>
		</div>
	</div>
</template>
