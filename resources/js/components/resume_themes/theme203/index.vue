      ...
      <v-dialog v-model="emailModal" persistent max-width="759" class="email-modal">
        <v-card class="card-email">
          <div class="title-container-email">
            <div class="modal-title" v-show="!isMessageSent">Message</div>
            <div class="modal-title" v-show="isMessageSent"></div>
            <div>
          ...
          <v-card-text class="mt-lg-0 mt-8">
            <v-card class="pa-lg-10" flat color="transparent" v-show="!isMessageSent">
              <v-text-field
                class="email-input"
                color="#E0BB4C"
                placeholder="Name"
            ...
            <v-card class="pa-lg-10" flat color="transparent" v-show="isMessageSent">
              <div class="d-flex success-message">Your message has been sent successfully!</div>
            </v-card>
          </v-card-text>
        </v-card>
      </v-dialog>
