...
=======
            ...
            <v-container style="width: 100%" class="pa-md-0 pa-sm-5 pa-5">
                ...
                <v-row no-gutters align="center" justify="center">
                    <v-col cols="12" md="10">
                        <v-card flat color="transparent" tile>
>>>>>>> e6de738b31aa0605d7931483d453451ed1237241
                            <v-card-text>
                                <v-tabs
                                        v-model="mainDataTab"
                                        color="black"
                ...
                <v-card class="card-email" v-show=" ! isMessageSent">
                    ...
                    <v-card-text class="mt-lg-0 mt-8">
                        <v-card class="pa-lg-10" flat color="transparent">
                            ...
                            ></v-text-field>
                            <v-textarea color="#E0BB4C" placeholder="Message"
                                        v-model="postData.message.body" :error="!!errors.body"
                                        :error-messages="errors.body"></v-textarea>
                            <div class="mt-5 d-flex" style="justify-content: center">
                                <v-btn color="#FCD259" @click="sendMessage" depressed class="btn-send-mail"
                                >Send
                                </v-btn
                                >
                            </div>
...
<style lang="scss">
    ...
    .success-message{
        justify-content: center;color: lawngreen;
        font-size: 24px;
        font-weight: 500;
    }
</style>