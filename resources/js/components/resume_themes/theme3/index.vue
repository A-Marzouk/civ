<template>
  <div class="d-flex justify-content-center w-100">
    <div class="themeWrapper" v-if="currentUser">
      <div
        class="mainThemeBar d-flex flex-modal__audio justify-content-between align-items-center"
      >
            ...
            <div class="media-btns">
              <div class="audio-btn NoDecor">
                <a
                  ...
                  @click.prevent="audioPopup = !audioPopup"
                >
                  <img
                    src="/images/resume_themes/theme3/audio.svg"
                    alt="audio"
                  />
              ...
              <div class="video-btn NoDecor">
                <a
                  href="javascript:void(0)"
                  @click.prevent="videoPopup = !videoPopup"
                >
                  <img
                    src="/images/resume_themes/theme3/video.svg"
                    alt="video"
                  />
        ...
        <div
          class="right d-flex align-items-center justify-content-between hideOnPhone"
        >
          <div class="hourly-rate">
            <div class="rate-options">
              <span
                @click="selectCurrentPayment('hourly')"
                :class="{
                  active: currentPayment.salary_frequency === 'hourly',
                }"
                >Hourly</span
              >
              <span
                @click="selectCurrentPayment('weekly')"
                :class="{
                  active: currentPayment.salary_frequency === 'weekly',
                }"
                >Weekly</span
              >
              <span
                @click="selectCurrentPayment('monthly')"
                :class="{
                  active: currentPayment.salary_frequency === 'monthly',
                }"
                >Monthly</span
              >
            </div>
          ...
          <div class="weekly-availability">
            <div class="rate-options">
              <span
                @click="selectCurrentAvailability('weekly')"
                :class="{
                  active:
                    currentAvailability.available_hours_frequency === 'weekly',
                }"
                >Weekly</span
              >
              <span
                @click="selectCurrentAvailability('monthly')"
                :class="{
                  active:
                    currentAvailability.available_hours_frequency === 'monthly',
                }"
                >Monthly</span
              >
              <span
                @click="selectCurrentAvailability('yearly')"
                :class="{
                  active:
                    currentAvailability.available_hours_frequency === 'yearly',
                }"
                >Yearly</span
              >
            </div>
          ...
          <div class="d-flex flex-column justify-content-center">
            <div>
              <ul class="nav" id="myTab" role="tablist">
                <li
                  class="nav-item"
                  v-for="item in availibilityRateItems"
                  :key="item.id"
                >
                  <a
                  ...
                  >
                    <span
                      class="text-capitalize mobile-frequency"
          ...
          <div class="d-flex flex-column justify-content-center">
            <div>
              <ul class="nav" id="myTab" role="tablist">
                <li
                  class="nav-item"
                  v-for="item in availabilityHourItems"
                  :key="item.id"
                >
                  <a
                  ...
                  >
                    <span
                      class="text-capitalize mobile-frequency"
                      :class="currentAvailableTab == item.title ? 'active' : ''"
                      >{{ item.title }}</span
                    >
                  </a>
                </li>
        ...
        <div class="portfolio" v-show="activeTab === 'portfolio'">
          <slick class="portfolioSlides" ref="slick" :options="slickOptions">
            <div
              ...
              :key="project.id + '_projectImage'"
            >
              <img :src="getProjectMainImage(project)" alt="portfolio image" />
              <div class="slide-text">{{ project.name }}.</div>
            </div>
          </slick>
        </div>
          ...
          >
            ...
            <div class="skills-icons-bar" id="style-1">
              <div
                ...
                :key="skill.id + '_skill'"
                class="skill-item"
                v-show="skill.category === activeSkillTab"
              >
                <img
                  class="icon"
        ...
        <div class="work" v-show="activeTab === 'work'">
          ...
          >
            <div class="work-icon hideOnPhone">
              <img
                src="/images/resume_themes/theme3/work-icon.svg"
                alt="work-icon"
              />
            </div>
            <div class="work-info">
        ...
        <div class="work" v-show="activeTab === 'education'">
          ...
          >
            <div class="education-icon hideOnPhone">
              <img
                src="/images/resume_themes/theme3/education-icon.svg"
                alt="education-icon"
              />
            </div>
            <div class="work-info">
      ...
      <div class="media" v-if="audioPopup">
        <div class="media__content">
          ...
          <AudioCarousel class="media__content__audio"></AudioCarousel>
        </div>
      </div>
      <!-- Audio Modal -->

      <!-- Video Modal -->
      <div class="media" v-if="videoPopup">
        <div class="media__contentV">
          <a
            class="media__contentV_close"
            href="javascript:void(0)"
            @click.prevent="videoPopup = false"
            ><img
              src="/images/resume_themes/theme3/close.svg"
              alt="close-icon"
            />
      ...
      media: [
        {
          name: "Herio Syndeile",
          type: "audio",
          url: "/images/resume_themes/theme511/audio-1.mp3",
