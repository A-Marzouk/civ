<template>
  <div>
    <header class="tm700-header">
      <div
        class="tm700-inner tw-p-0 tw-w-full tw-my-0 xl:tw-mx-auto sm:tw-m-0 xl:tw-max-w-tm700-xl-2"
      >
        <div class="tm700-top tw-grid tw-items-stretch">
          ...
          <!-- icons -->
          <div
            class="tm700-icons tw-py-12 md:tw-pb-0 md:tw-pt-44px lg:tw-py-0 tw-col-start-1 tw-col-end-3 tw-row-start-2 lg:tw-row-start-1 lg:tw-col-start-3 lg:tw-col-start-4"
          >
...
.tm700-header {
  .tm700-top {
    ...
    @media (min-width: 1024px) {
      grid-template-columns: 98px 3fr 1fr 2fr;
