<template>
    <v-app style="width: 100%">
        ...
        <v-container ma-0 pa-0 fluid style="max-width: 100% !important; min-height: 100vh !important"
                     v-if="currentUser">
            <!-- Header Row -->
            <v-row no-gutters>
                <v-col cols="12">
                    ...
                    <v-card flat color="transparent" tile>
                        ...
                        <v-container fluid ma-0 pa-0 style="max-width: 100%">
                            <v-row no-gutters align="center" justify="center">
                                ...
                                <v-col lg="3" md="12" sm="12" cols="12" class="mt-n3 pa-0 hidden-lg-and-up"
                                       align="center">
                                        ...
                                        <v-card-text class="ml-lg-n5">
                                            <v-row no-gutters align="center" justify="center">
                                                ...
                                                <v-col xl="4" lg="4" md="4" sm="4" cols="4" align="center"
                                                    ...
                                                    <VueSlickCarousel v-bind="slickOptionsAvailability"
                                ...
                                {{ currentUser.personal_info.hometown }}
                                                    ...
                                                    >
                                                        ...
                                                        <div class="mt-3 d-flex flex-column">
                                                            <span v-for="(language, i) in currentUser.languages"
                                                                  :key="i">{{ language.label }}</span>
                                                        </div>
                                                    </v-card-subtitle>
                                                </v-card>
                                            </v-col>
                                            ...
                                            <v-col xl="4" lg="7" md="7" sm="7" cols="12" order-sm="12" order="1">
                                                <v-card class="card-about-right" flat color="transparent">
                                                    <v-card-subtitle class="overview-title"
                                                                     v-if="currentUser.personal_info.overview"
                                                    >Overview summary
                                                    </v-card-subtitle>
                                                    <!-- Overview -->
                                                    <v-card-text class="overview-text"
                                                                 v-if="currentUser.personal_info.overview">
                                                    ...
                                                    <div class="custom-hr hidden-xs-only"
                                                         v-show="currentUser.personal_info.about"></div>
                                                    <v-card-text class="overview-text"
                                                                 v-if="currentUser.personal_info.about"
                                                    ...
                                                    <!-- location -->
                                                    <hr class="custom-hr-mobile hidden-sm-and-up"
                                            ...
                                            <v-container fluid ma-0 pa-0 style="width: 100%">
                                                <v-row>
                                                    <template v-for="(work, index) in currentUser.work_experience">
                                                        <v-col cols="12" sm="12" md="6" class="mb-12" :key="index"
                                            ...
                                            <template v-for="skill in currentUser.skills">
                                                ...
                                                >
                                                    <v-card flat color="transparent" tile class="mx-auto">
                                                        <v-card-text>
                                                            <v-list-item>
                                                                <v-list-item-avatar class="skill-circle mr-n1 mt-sm-2"
                                                                                    style="z-index: 1">
                                        ...
                                        <v-container ma-0 pa-0 fluid style="width: 100%">
                                            <v-row align="center">
                                                <template v-for="(hobby, index) in currentUser.hobbies">
                                                    <v-col lg="4" md="6" sm="6" cols="6" class="mb-5" :key="index"
                                                           v-show="hobby.is_public == 1">
                                                        <v-list-item>
                                                            <v-list-item-avatar class="hobbies-avatar">
                                                                <img src="/images/resume_themes/theme203/icons/hobby.svg"
                                                                     alt="hobby icon"/>
                                                            </v-list-item-avatar>
                                                            <v-list-item-content>
                                ...
                                windowWidth <= 1263 ? 'd-flex achievement flex-column' : 'd-flex achievement flex-row'
                                                        ...
                                                        >
                                                            <div :align="windowWidth <= 1263 ? 'center' : 'left'">
                                                                <img class="mt-5" :src="achievement.image_src"
                                        ...
                                        <v-container ma-0 pa-0 style="width: 100%">
                                            <v-row align="center" justify="space-between">
                                                <template v-for="(reference, index) in currentUser.references">
                                                    <v-col xl="5" lg="5" md="12" sm="12" cols="12" class="mb-5"
                                                           :key="index">
                                                        <v-card flat color="transparent">
                                                            <v-row>
                                                                <v-col cols="7">
            ...
            >
                <v-card class="card-audio-modal">
                    <div class="title-container">
                        ...
                        <div>
                            <v-btn icon depressed class="btn-audio-modal-close" @click="audioModal = false"
                                   style="z-index: 101">
                                <img src="/images/resume_themes/theme203/icons/email-close.svg" alt="close"/>
                            </v-btn>
                        </div>
...
<script>
    ...
    import AudioPlayer from '../theme203/media/AudioPlayer';
    import VideoPlayer from '../theme203/media/VideoPlayer';
    import VueSlickCarousel from 'vue-slick-carousel';
    import IconCarousel from '../reusable/IconCarousel';
    //import ImagesCarouselModal from "../reusable/ImagesCarouselModal";
    import Portfolio from '../theme203/tabs/Portfolio';
