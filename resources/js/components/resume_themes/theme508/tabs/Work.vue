      ...
      <div class="tw-col-start-1">
        <div class="tw-flex tw-flex-row tw-items-center tw-mb-18px">
          <svg
            ...
            viewBox="0 0 44 44"
          >
            <g id="Group_10380" data-name="Group 10380" transform="translate(0 0.118)">
              <g
                id="Ellipse_177"
              ...
              <g id="Group_3" data-name="Group 3" transform="translate(9 9.157)">
                <g id="suitcase-with-white-details" transform="translate(4 -31.824)">
        ...
        <div class="tw-pl-96px">
          <div class="tw-pb-56px">
            ...
            <p class="tw-font-normal tw-text-lg tw-leading-27px tw-font-muli tw-text-tm701-8">
              Get, keoo and grow more customers with customer engagement
              Automation by kissmetrics. Get, keoo and grow more customers with
              customer engagement.
            </p>
          </div>
          <div class="tw-pb-56px">
...
export default {
  ...
  data() {
    return {
      works: [
        { id: 1, name: "google", dateFrom: new Date(), dateTo: new Date() },
        { id: 2, name: "google", dateFrom: new Date(), dateTo: new Date() },
        { id: 3, name: "Adobe", dateFrom: new Date(), dateTo: new Date() },
        { id: 4, name: "Adobe", dateFrom: new Date(), dateTo: new Date() }
      ]
    };
  }
};
