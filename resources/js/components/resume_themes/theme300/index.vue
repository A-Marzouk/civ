    ...
    <v-container class="hold_theme3" style="max-width: 1920px;">
      <v-row class="freelancerCard" v-if="currentUser">
        <v-col lg="12" md="12" cols="12" class="resumeCardRight">
          <div class="showOnlyOnmd">
            <v-row class="head-section">
              <v-col lg="2" md="2" sm="2" cols="2" class="imageCol">
                <span
                  class="profile-img"
                  v-bind:style="{ backgroundImage: 'url(/images/resume_themes/theme300/profile.jpg)' }"
                />
                <a href="#" class="chat-option" @click.prevent="dialogMessage = true">
              ...
              <v-col lg="5" md="4" sm="5" cols="3" class="interviewSection">
                ...
                <div class="option-wrap">
                  <a href="#" class="btn-default" @click.prevent="dialogAudio = true">
                    <v-icon>mdi-microphone</v-icon>Audio &amp; Text
                  </a>
                  <a href="#" class="btn-default" @click.prevent="dialogVideo = true">
                    <v-icon>mdi-play-circle</v-icon>Video
                  </a>
                </div>
              </v-col>
                ...
                <v-container class="hold-rates">
                  <v-row class="rate-wrap" no-gutters>
                    <v-col lg="4" md="4" sm="4">
                      <span class="price">${{currentPayment.salary}}</span>
                      <span class="text_price">Hourly Rate</span>
                    </v-col>
                    <v-col lg="6" md="4" sm="4">
                      <span class="hours">{{currentAvailability.available_hours}} hrs</span>
                      <span class="text_hours">Weekly Avaiablitys</span>
                    </v-col>
          ...
          <div class="hold-tabs">
            <v-tabs class="main-tabs_theme3" v-model="activeTab" :slider-color="colorTab">
                  ...
                  >
                    ...
                    <v-card class>
                      <v-card-title class="headline">
                        <span class="title-job">{{work.job_title}}</span>
              ...
              >
                <v-timeline :reverse="reverseTimeline">
                  ...
                  >
                    ...
                    <v-card class>
                      <v-card-title class="headline">
                        <span class="title-job">{{education.university_name}}</span>
                        <span class="title-mob">
                          {{education.date_from}}
                          <span>- {{education.present ? 'Present' : education.data_to}}</span>
                        </span>
                      </v-card-title>
                      <v-card-text>{{education.institution_type}}</v-card-text>
                    </v-card>
                  </v-timeline-item>
                </v-timeline>
              </v-tab-item>
          ...
          <v-container>
            ...
            <v-row>
              <v-btn depressed small @click="submitForm" class="btn-send">
                <v-icon>mdi-message-text</v-icon>Send Message
              </v-btn>
    ...
    .v-timeline-item {
      .v-card {
        .headline {
          ...
          &::before {
            background: url("/images/resume_themes/theme300/icons/icon-designer.png")
              no-repeat;
            background-position: center;
            background-size: 50%;
          }
