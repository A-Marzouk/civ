	...
	<div class="tw-flex tw-flex-wrap tw-w-full tw-p-37px">
		<div v-for="portfolio in portfolios" :key="portfolio.id" class="tw-w-1/3 tw-p-9px">
			<div class="tw-relative" @click="showSelectedPortfolio(portfolio)">
				<div class="tw-absolute tw-top-0 tw-right-0 tw-text-black tw-mt-10px tw-mr-10px">
					<svg viewBox="0 0 9 10" class="tw-w-9px tw-h-10px tw-fill-current" xmlns="http://www.w3.org/2000/svg">
				...
				<img :src="portfolio.url" class="tw-rounded-10px">
			</div>
		</div>
