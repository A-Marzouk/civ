<template>
	<div class="tw-px-4 tw-pt-16 tw-pb-12 screen425px:tw-px-37px screen425px:tw-max-w-4xl screen1024px:tw-max-w-1522px tw-text-black">
		<h2 class="tw-font-poppins tw-font-medium tw-text-xl tw-leading-30px screen425px:tw-text-30px screen425px:tw-leading-civ-29">About me</h2>
		<div class="tw-font-poppins tw-leading-4 tw-text-xs tw-pt-10px screen425px:tw-pt-15px screen425px:tw-text-lg screen425px:tw-leading-7 screen1024px:tw-max-w-5xl">
