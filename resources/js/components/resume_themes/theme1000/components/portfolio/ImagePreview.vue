<template>
	<div v-if="isOpen" ref="imagePreview" class="image-preview tw-p-14px tw-z-10" @click="onClose">
		<div class="tw-relative tw-w-5/6 screen425px:tw-w-1/2 tw-z-20">
			<div class="tw-absolute tw-top-0 tw-right-0 tw-text-black tw-pt-14px tw-pr-14px tw-cursor-pointer screen425px:tw-pt-30px screen425px:tw-pr-30px" @click="$emit('onClose')">
				<svg viewBox="0 0 9 10" class="tw-w-14px tw-h-14px tw-fill-current screen425px:tw-w-22px screen425px:tw-h-22px" xmlns="http://www.w3.org/2000/svg">
			...
			<img :src="url" class="tw-w-full tw-rounded-10px screen425px:tw-rounded-civ-50p">
		</div>
	</div>
</template>
