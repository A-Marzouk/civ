<template>
	<div class="tw-flex tw-items-center tw-justify-around tw-max-w-xs tw-mx-auto md:tw-max-w-2xl">
		...
		<TabButton label="Skills" :isActive="currentTab == 'skills'" @click="$emit('tabChanged', 'skills')">
			<svg class="tw-w-6 tw-h-6 tw-fill-current" viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
		...
		<TabButton label="Media" :isActive="currentTab == 'media'" @click="$emit('tabChanged', 'media')">
			<svg class="tw-w-6 tw-h-6 tw-fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
