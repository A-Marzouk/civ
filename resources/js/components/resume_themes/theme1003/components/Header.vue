      ...
      <div class="current-user__detail-wrapper">
        <div class="current-user__detail">
          <div class="tw-flex-1">
            ...
            <div
              class="current-user__detail--motivation"
              v-html="getShortString(currentUser.personal_info.about)"
            ></div>
          ...
          <div class="current-user__detail--contact">
            ...
            <a href="#" class="contact__link contact__link--facebook">
              <svg class="tw-fill-current" viewBox="0 0 13 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M10.1156 3.98438H12.375V0.16875C11.9859 0.117187 10.6453 0 9.08438 0C5.82656 0 3.59531 1.9875 3.59531 5.63906V9H0V13.2656H3.59531V24H8.00156V13.2656H11.4516L12 9H8.00156V6.06094C8.00156 4.82812 8.34375 3.98438 10.1156 3.98438Z"
                />
              </svg>
            </a>
            ...
            <a
              href="#"
              class="contact__link contact__link--hireme"
              @click.prevent="$emit('showModal', 'PaymentMethods')"
            >
