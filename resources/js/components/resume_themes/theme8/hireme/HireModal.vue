<template>
  <v-dialog v-model="hireToggle" max-width="567" persistent>
    <v-card color="#F6F9FF" class="card-hire-me-modal pa-sm-3 pa-5">
      ...
      >
        <v-card flat class="card-payment pa-5" align="left">
          ...
          <div class="total-payment-text"><span class="mr-2">$</span>400</div>
      ...
      <v-card-subtitle class="hidden-sm-and-up" align="center">
        <div class="d-flex flex-column" align="center">
          ...
          <div
            class="d-flex flex-row mt-3 justify-content-center"
            align="center"
          >
