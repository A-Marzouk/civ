            ...
            <div class="social">
              <div class="d-flex">
                <div class="message-btn d-flex">
                  <a href="javascript:void(0)" @click.prevent="openChatModal">
                    <img
              ...
              <div class="icons NoDecor">
                ...
                >
                  <img
                    :src="`/images/resume_themes/theme8/social_icons/${stringToLowerCase(
                      item.link_title
                    )}.webp`"
                    alt="social icon"
                  />
      ...
      <div class="prof-left">
        <div class="hours text-center">
          ...
          <div class="text" style="text-transform: capitalize">
            ...
            <v-icon small dark @click="paymentInfoNext()">navigate_next</v-icon>
          </div>
        ...
        <div class="rate text-center">
          <div class="text">
            ...
            <v-icon small dark @click="availableNext()">navigate_next</v-icon>)
          </div>
