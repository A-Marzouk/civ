<template>
  <div id="theme39" style="width: 1920px;
height: 1080px;">
    <header class="w-full">
      <div class="mycontainer p-0">
        <div class="top flex flex-row items-stretch">
          ...
          <div class="right col-span-2 flex flex-col items-stretch">
            ...
            <p
              class="font-bold not-italic text-gray-701 leading-10 font-medium leading-4"
          ...
          <div class="hire">
            <div class="flex items-center">
              <div class="hourly--rate flex flex-col">
...
<script>
import IconMaterialEmail from "./../../../../public/images/resume_themes/theme39/icon-material-email.svg";
export default {
  components: { IconMaterialEmail },
  data() {
    return {};
  },
...
div#theme39 {
  header {
    ...
    div.top {
      > * {
        @apply p-6 border border-red-800;
      }
      div.left {
