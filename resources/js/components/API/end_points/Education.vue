                        ...
                        <code class="prettyprint p-4 lang-js">
{
    "data": [
        {
            "id": 1,
            "institution_type": "Ad minus in et ipsam.",
            "university_name": "Culpa et illum et odit.",
            "degree_title": "Ut iure ut doloribus.",
            "date_from": "1975-08-29",
            "date_to": "2009-12-16",
            "present": 1,
            "user_id": 2,
    ...
    "links": {
        "first": "http://localhost:8080/api/user/education?page=1",
        "last": "http://localhost:8080/api/user/education?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": 1,
        "last_page": 1,
        "path": "http://localhost:8080/api/user/education",
        "per_page": 5,
        "to": 3,
        "total": 3
    }
                        ...
                        <code class="prettyprint p-4 lang-js">
{
    "message": "Unauthenticated."
        ...
        <v-card class="mx-auto mt-5" max-width="95%" outlined>
            <v-list-item three-line>
                <v-list-item-content>
                    <div class="overline mb-4">Create {{current_endpoint}} record | <b>Example request</b> | Javascript</div>
                        ...
                        <code class="prettyprint p-4 lang-js">
{
    "data": {
        "user_id": "2",
        "institution_type": "University",
        "university_name": "ZNTU",
        "degree_title": "Bachelor",
        "date_from": "2005-10-11",
        "date_to": null,
        "present": "1",
        "updated_at": "2020-05-06 07:02:18",
        "created_at": "2020-05-06 07:02:18",
        "id": 4
    },
    "version": "1.0.0",
...
axios.put('/api/user/{{current_endpoint_url}}',
    {
        id:4, // id of the edited record
        university_name: Updated name
        user_id: 4
    }
);
                        </code>
                        ...
                        <code class="prettyprint p-4 lang-js">
{
    "data": {
        ...
        "user_id": "2",
        "created_at": "2020-05-06 07:02:18",
        "updated_at": "2020-05-06 07:06:29"
    },
    "version": "1.0.0",
    "author_url": "https://civ.ie"
}
                        ...
                        <code class="prettyprint p-4 lang-js">
{
    "message": "Not Authenticated!"
        ...
        <v-card class="mx-auto mt-5" max-width="95%" outlined>
            <v-list-item three-line>
                <v-list-item-content>
                    <div class="overline mb-4">Delete {{current_endpoint}} record | <b>Example request</b> | Javascript</div>
                    <v-list-item-title class="headline mb-1 mb-3"> DELETE: api/user/{{current_endpoint_url}}/{id} </v-list-item-title>
                    <v-list-item-subtitle class="d-flex flex-column">
        ...
        data() {
            return {
                ...
                headers_before_auth: "{ " +
                    ...
                    "\n" +
                    "  ",
                current_endpoint: 'Education',
                current_endpoint_single: 'education',
                current_endpoint_url: 'education',
            }
        }
    }
</script>
