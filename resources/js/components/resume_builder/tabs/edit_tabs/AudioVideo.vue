                                    ...
                                    <v-card class="card-holder pa-2 mb-3 mt-3">
                                        <v-row justify="center">
                                                ...
                                                <v-card class="card-audio-controller" height="40" color="#F2F3FD" flat>
                                                    <v-row justify="center" align="center" dense class="card-audio-row">
                                                        ...
                                                        <v-col cols="4" class="mt-1">
                                                            <v-progress-linear color background-color="#C4C9F5"
                                                                               class="seekbar"></v-progress-linear>
                                                        </v-col>
                                                        <v-col cols="3" class="mt-1">
                                                            <v-card color="transparent" flat tile>
                                                                <v-btn icon small>
                                            ...
                                            >
                                                ...
                                                <v-btn color="#F2F3FD" depressed class="btn-skill-action mr-auto">
                                                    <img src="/images/new_resume_builder/icons/main/edit-skill.svg"
                                                         alt/>
                                                </v-btn>
                                                <v-btn color="#F2F3FD" depressed class="btn-skill-action mr-auto">
...
>>>>>>> 420559d556fdd3e07a34928daf13238096b5f320
            }
        },
        methods: {
            handleAudioUpload() {
