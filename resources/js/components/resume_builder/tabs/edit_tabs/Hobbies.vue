          ...
          <v-container style="width: 100%;">
              ...
              <v-row align="center">
                ...
                <v-col xl="3" lg="4" md="6" sm="6" cols="12">
                  <v-btn
                    ...
                    raised
                    @click="saveHobby"
                  >{{editedHobby.id !== '' ? 'Update' : 'Add New'}}</v-btn>
            ...
            <draggable v-model="hobbies" @start="drag=true" @end="drag=false" handle=".drag-btn">
              <v-row
                ...
                :key="hobby.id"
                v-if="hobbies"
                :class="{'half-opacity' : !hobby.is_public}"
              >
                <v-col xl="6" lg="8" md="8" sm="10" cols="12">
                  <v-card class="card-holder pa-2 mb-3">
                    <v-row justify="center">
                      ...
                      >
                        <v-btn class="btn-icon civie-btn" depressed @click="toggleHobby(hobby)">
                          <svg-vue
                            icon="eye-icon"
                        ...
                        <v-btn class="btn-icon civie-btn" @click="editHobby(hobby)" depressed>
                          <svg-vue
                            icon="edit-icon"
                            class="icon"
                        ...
                        <v-btn class="btn-icon civie-btn" @click="deleteHobby(hobby)" depressed>
...
export default {
  ...
  methods: {
    ...
    saveHobby() {
      ...
      axios
        .post("/api/user/hobbies", this.editedHobby)
        .then((response) => {
          if (!edit) {
