<template>
  <div class="main-content" id="portfolio-tab">
    <div class="d-flex justify-content-end w-100">
      <tab-switcher currentTabTitle="achievements"></tab-switcher>
    </div>
      ...
      <v-card class>
        <v-form class="grid-form" ref="form">
          ...
          <div class="col-12 d-flex flex-column" style="transform: translateX(-9px)">
            <div class="d-flex">
              ...
              >{{editedAchievement.id !== '' ? 'Update' : 'Add New'}}</v-btn>
        ...
        >
          <div
            ...
            :class="{'half-opacity' : !achievement.is_public}"
          >
            <div class="project__header">
              ...
              <div class="resume-builder__action-buttons-container">
                <v-btn class="btn-icon civie-btn" depressed @click="toggleAchievement(achievement)">
                  <svg-vue
                    icon="eye-icon"
                ...
                <v-btn class="btn-icon civie-btn" @click="editAchievement(achievement)" depressed>
                  <svg-vue
                    icon="edit-icon"
                    class="icon"
                ...
                <v-btn class="btn-icon civie-btn" @click="deleteAchievement(achievement)" depressed>
            ...
            <div class="project__body">
              <div class="project__img">
                ...
                <img :src="achievement.image_src" alt="achievement img" />
              </div>
              <div class="project__info">
                <div class="project__name">{{achievement.title}}</div>
                <div class="project__url">
                  <b>URL:</b>
                  <a :href="achievement.url">{{achievement.url}}</a>
                </div>
...
export default {
  ...
  methods: {
    ...
    toggleAchievement(achievement) {
      ...
      axios
        .put("/api/user/achievements", achievement)
        .then(() => {
    ...
    saveAchievement() {
      ...
      axios
        .post("/api/user/achievements", formData, {
...
#portfolio-tab {
  .view-container {
    ...
    margin: 0 auto;
    padding-right: 20px;
    background-color: rgba(247, 247, 253,1.0) !important;
