...
class PayPalForAgentsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if(config('paypal.settings.mode') == 'live'){
            ...
            $this->monthly_three_plan_id = env('PAYPAL_LIVE_3MONTHLY_PLAN_ID', '');
            ...
            $this->monthly_three_plan_id = env('PAYPAL_SANDBOX_3MONTHLY_PLAN_ID', '');
    ...
    public function createMonthlyPlan($freq){
    ...
    public function subscribePayPalCustomMonthly($freq){
        ...
        if($freq == '1'){
            ...
            $plan->setId($this->monthly_three_plan_id);
        }
